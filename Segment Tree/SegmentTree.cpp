...
/*
  getSum() takes starting and ending indicies and if 0 and last index is passed as args
  then time complexity of this becomes O(N), but by using the segment tree TC becomes O(logN)
*/
